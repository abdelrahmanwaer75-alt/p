...
class MediaFormat with _$MediaFormat {
  ...
  factory MediaFormat.fromJson(Map<String, dynamic> json) => MediaFormat(
    ...
    estimatedSizeBytes: (json['estimated_size_bytes'] as num?)?.toInt(),
  );
  Map<String, dynamic> toJson() => {
    'format_id': formatId,
    'extension': extension,
...
class AnalyzerResult with _$AnalyzerResult {
  ...
  factory AnalyzerResult.fromJson(Map<String, dynamic> json) => AnalyzerResult(
    ...
    formats: _list(json['formats']).map(MediaFormat.fromJson).toList(),
    audioFormats: _list(json['audio_formats'])
        .map(MediaFormat.fromJson)
        .toList(),
    videoFormats: _list(json['video_formats'])
        .map(MediaFormat.fromJson)
        .toList(),
  ...
  Map<String, dynamic> toJson() => {
    ...
    'audio_formats': audioFormats.map((e) => e.toJson()).toList(),
    'video_formats': videoFormats.map((e) => e.toJson()).toList(),
...
class DownloadTask with _$DownloadTask {
  ...
  factory DownloadTask.fromJson(Map<String, dynamic> json) => DownloadTask(
    id: json['id'] as String? ?? '',
    userId: (json['user_id'] ?? json['owner_id']) as String? ?? '',
...
class ManagedFile with _$ManagedFile {
  ...
  factory ManagedFile.fromJson(Map<String, dynamic> json) => ManagedFile(
    ...
    duration: (json['duration'] as num?)?.toInt(),
    modifiedAt: _date(json['modified_at']),
    isFavorite: json['is_favorite'] as bool? ?? false,
    title: json['title'] as String? ?? 'Untitled',
  );
  final String title;
...
class Playlist with _$Playlist {
  ...
  factory Playlist.fromJson(Map<String, dynamic> json) => Playlist(
    ...
    description: json['description'] as String?,
    items: _list(json['items']).map(PlaylistItem.fromJson).toList(),
    createdAt: _date(json['created_at']),
    updatedAt: _date(json['updated_at']),
  );
  Map<String, dynamic> toJson() => {
