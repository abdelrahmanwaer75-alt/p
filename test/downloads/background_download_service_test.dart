...
void main() {
  test('parses native progress event', () {
    final event = BackgroundDownloadEvent.fromMap({'task_id': 'task-1', 'event': 'download.progress', 'progress': 42, 'bytes_downloaded': 420, 'total_bytes': 1000});
  ...
  test('parses notification tap event', () {
    final event = BackgroundDownloadEvent.fromMap({'task_id': 'task-2', 'event': 'download.notification_tap', 'open': true});
